...
class Program
{
    static void Main(string[] args)
    {
        ...
        foreach (IObject object_ in Object_S)
        {
            string temp = object_.GetType().Name;
            switch (temp)
            {
                case "SinhVien":
                    {
                        Console.WriteLine("SinhVien");
                        SinhVien test = (SinhVien)object_;
                        Console.WriteLine(test.Name + "," + test.DateOfBirth + "," + test.Address + "," + test.Gender + "," + test.Years + "," + test.Academic_Year + "," + test.School + "," + test.Field_of_Study);
                        break;
                    }
                case "HocSinh":
                    {
                        Console.WriteLine("Hoc sinh");
                        HocSinh test = (HocSinh)object_;
                        Console.WriteLine(test.Name + "," + test.DateOfBirth + "," + test.Address + "," + test.Gender + "," + test.School + "," + test.Class);
                        break;
                    }
                case "CongNhan":
                    {
                        Console.Write("Cong nhan:");
                        CongNhan test = (CongNhan)object_;
                        Console.WriteLine(test.Name + "," + test.DateOfBirth + "," + test.Address + "," + test.Gender + "," + test.WorkAddress + "," + test.Salary);
                        break;
                    }
                case "NgheSi":
                    {
                        Console.Write("Nghe si:");
                        NgheSi test = (NgheSi)object_;
                        Console.WriteLine(test.Name + "," + test.DateOfBirth + "," + test.Address + "," + test.Gender + "," + test.Pseudonym + "," + test.Field);
                        break;
                    }
                case "CaSi":
                    {
                        Console.Write("Ca si:");
                        CaSi test = (CaSi)object_;
                        Console.WriteLine(test.Name + "," + test.DateOfBirth + "," + test.Address + "," + test.Gender + "," + test.Pseudonym + "," + test.Field);
                        break;
                    }
                default:
